...
import CurrentTaskFunctions from './CurrentTaskFunctions';


export default function CurrentTask({user}) {
  ...
  return (
    <div className="inline-flex bg-secondary flex-col mt-10 gap-5 lg:w-[35vw] border border-y-[#2c1f42] border-x-[#2f3763] phones:p-10 phones:w-screen phones:m-auto  p-4 max-h-[400px] lg:max-h-[800px] overflow-y-auto" >
      ...
      <h2 className="text-white mb-2 phones:text-lg  text-2xl font-semibold">Current Task</h2>
    ...
    <CurrentTaskFunctions setData={setData} month={month} data={data} user={user} setMatchingData={setMatchingData} matchingData={matchingData} />
