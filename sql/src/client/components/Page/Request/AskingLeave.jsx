  ...
  <LeaveTitle user={user}  updatedPto={updatedPto} updatedWfh={updatedWfh}/>
         ...
         <section className='mt-20 bg-secondary p-10 w-full rounded-lg border-tertiary border-2 shadow-card2'>
            ...
            <form onSubmit={handleSubmit} className="flex flex-row justify-center gap-10 items-start">
                ...
                <button type="button" onClick={() => { setRequestType('WFH'); setModalIsOpen(true); }} className="mb-4 p-2 bg-green-500 text-white rounded hover:text-green-500 hover:bg-white" >Request WFH</button>
            </form>

            <Modal isOpen={modalIsOpen} onRequestClose={() => setModalIsOpen(false)} className='bg-slate-900 laptop:h-1/2 p-10 laptop:w-1/2 text-white'>
