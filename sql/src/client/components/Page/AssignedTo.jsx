...
export default function AssignedTo({ assigned, setAssigned, level ,page,post,month,dbId}) {
    ...
    return (
        <div className='text-black mt-5 flex justify-center items-center gap-2'>
            ...
            {showConfirmation && (
                <div className='flex items-center justify-center gap-4 pt-1 '>
                    <p className='text-white'>Confirm to {selectedUser}?</p>
            ...
            {message && (
                <div className='bg-blue-500 text-white text-center mt-2 py-2 px-4 rounded w-[20vw] '>
                    <p>{message}</p>
                </div>
            )}
        </div>
