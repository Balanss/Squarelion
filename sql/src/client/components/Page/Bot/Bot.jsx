...
const Bot = ({ setObjectiveAnswer, user, subject }) => {
  ...
  return (
    <div className="App bg-slate-800 phones:hidden hidden lg:block border-2 ">
      <div className="flex bg-slate-900 text-white text-center font-bold justify-center gap-7 p-2">
        <h1> {user} Chatbot </h1>
      </div>

      <section className=" bg-[#171717] text-black  p-[20px] min-h-[600px] max-h-[600px] lg:w-[800px] xl:w-[400px] 2xl:min-h-[750px] 2xl:max-h-[750px] overflow-y-auto overflow-x-auto flex flex-col-reverse shadow-lg">
