  ...
  return (
    <>
      ...
      Calendar
        ...
        <hr />
        <section className="flex justify-center gap-5 wrap sm:w-[75vw] flex-col text-black phones:overflow-auto phones:h-screen phones:justify-start  laptopL:w-full laptopL:flex-row  ">
