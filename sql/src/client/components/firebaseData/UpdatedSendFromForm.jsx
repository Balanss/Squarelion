...
{level > 7 && <>
 ...
 <img src={send} onClick={handleData} className='w-12 h-12 cursor-pointer hover:scale-[1.1]'  title='Post'/> 
      {success !== false &&     <div id="toast-success" className=" absolute z-[1] flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
