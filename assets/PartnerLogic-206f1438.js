import{p as Ce,q as xe,r as le,t as Ie,e as ve,c as De,j as Le,_ as Be,d as Me,v as Fe,T as qe,C as He}from"./index-ad0cde8e.js";import{n as $,p as ze,q as je,s as $e,t as Ge,C as Xe,v as se,w as Ve,S as We,F as Ke,x as Ze,f as Ye}from"./Nav-1ba6dc8b.js";const Je=["className","component"];function Qe(t={}){const{themeId:e,defaultTheme:n,defaultClassName:s="MuiBox-root",generateClassName:r}=t,i=Ce("div",{shouldForwardProp:u=>u!=="theme"&&u!=="sx"&&u!=="as"})(xe);return le.forwardRef(function(a,c){const l=Ie(n),d=ve(a),{className:_,component:p="div"}=d,m=De(d,Je);return Le.jsx(i,Be({as:p,ref:c,className:Me(_,r?r(s):s),theme:e&&l[e]||l},m))})}/**
 * @license
