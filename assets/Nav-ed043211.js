import{v as W,w as De,x as Le,z as Be,A as Me,C as Fe,B as ae,D as qe,S as He,E as ze,G as je,r as N,i as _e,u as $e,R as Ge,a as $,F as Y,j as E,U as Xe,e as Ve,L as We}from"./index-1bcc9aca.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(t,e,n){let s=1,r=null,i=null,o=!1,u=0;function a(){return u===2}let l=!1;function c(...d){l||(l=!0,e.apply(null,d))}function p(d){r=setTimeout(()=>{r=null,t(g,a())},d)}function m(){i&&clearTimeout(i)}function g(d,...A){if(l){m();return}if(d){m(),c.call(null,d,...A);return}if(a()||o){m(),c.call(null,d,...A);return}s<64&&(s*=2);let R;u===1?(u=2,R=0):R=(s+Math.random())*1e3,p(R)}let b=!1;function y(d){b||(b=!0,m(),!l&&(r!==null?(d||(u=2),clearTimeout(r),p(0)):d||(u=1)))}return p(0),i=setTimeout(()=>{o=!0,y(!0)},n),y}function dt(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pt(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function It(t,e){const n=e.split("/").filter(s=>s.length>0).join("/");return t.length===0?n:t+"/"+n}function Se(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+a+"--",g=I.getBlob(p,s,m);if(g===null)throw Re();const b={name:l.fullPath},y=z(i,t.host,t._protocol),d="POST",A=t.maxUploadRetryTime,f=new M(y,d,re(t,n),A);return f.urlParams=b,f.headers=o,f.body=g.uploadData(),f.errorHandler=j(e),f}class V{constructor(e,n,s,r){this.current=e,this.total=n,this.finalized=!!s,this.metadata=r||null}}function ie(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{v(!1)}return v(!!n&&(e||["active"]).indexOf(n)!==-1),n}function jt(t,e,n,s,r){const i=e.bucketOnlyServerUrl(),o=Ie(e,s,r),u={name:o.fullPath},a=z(i,t.host,t._protocol),l="POST",c={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${s.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},p=ve(o,n),m=t.maxUploadRetryTime;function g(y){ie(y);let d;try{d=y.getResponseHeader("X-Goog-Upload-URL")}catch{v(!1)}return v(K(d)),d}const b=new M(a,l,g,m);return b.urlParams=u,b.headers=c,b.body=p,b.errorHandler=j(e),b}function $t(t,e,n,s){const r={"X-Goog-Upload-Command":"query"};function i(l){const c=ie(l,["active","final"]);let p=null;try{p=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{v(!1)}p||v(!1);const m=Number(p);return v(!isNaN(m)),new V(m,s.size(),c==="final")}const o="POST",u=t.maxUploadRetryTime,a=new M(n,o,i,u);return a.headers=r,a.errorHandler=j(e),a}const ce=256*1024;function Gt(t,e,n,s,r,i,o,u){const a=new V(0,0);if(o?(a.current=o.current,a.total=o.total):(a.current=0,a.total=s.size()),s.size()!==a.total)throw ot();const l=a.total-a.current;let c=l;r>0&&(c=Math.min(c,r));const p=a.current,m=p+c;let g="";c===0?g="finalize":l===c?g="upload, finalize":g="upload";const b={"X-Goog-Upload-Command":g,"X-Goog-Upload-Offset":`${a.current}`},y=s.slice(p,m);if(y===null)throw Re();function d(w,S){const P=ie(w,["active","final"]),F=a.current+c,C=s.size();let Z;return P==="final"?Z=re(e,i)(w,S):Z=null,new V(F,C,P==="final",Z)}const A="POST",f=e.maxUploadRetryTime,R=new M(n,A,d,f);return R.headers=b,R.body=y.uploadData(),R.progressCallback=u||null,R.errorHandler=j(t),R}const k={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function ee(t){switch(t){case"running":case"pausing":case"canceling":return k.RUNNING;case"paused":return k.PAUSED;case"success":return k.SUCCESS;case"canceled":return k.CANCELED;case"error":return k.ERROR;default:return k.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe="storage";function ln(t,e,n){return t=W(t),Zt(t,e,n)}function cn(t){return t=W(t),Yt(t)}function hn(t,e){return t=W(t),tn(t,e)}function dn(t=Be(),e){t=W(t);const s=De(t,xe).getImmediate({identifier:e}),r=Le("storage");return r&&sn(s,...r),s}function sn(t,e,n,s={}){nn(t,e,n,s)}function rn(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new oe(n,s,r,e,He)}function on(){Me(new Fe(xe,rn,"PUBLIC").setMultipleInstances(!0)),ae(de,fe,""),ae(de,fe,"esm2017")}on();function an({setUserPermit:t}){const e=async()=>{try{return _e.collection("admin").onSnapshot(s=>{const r=s.docs.map(i=>({id:i.id,...i.data()}));r.sort((i,o)=>i.id-o.id),t(r)})}catch(n){console.error("Error fetching user permit data:",n)}};N.useEffect(()=>{e()},[])}function fn(){const[t,e]=N.useState(0),[n,s]=N.useState(""),[r,i]=N.useState(""),[o,u]=N.useState(""),a=$e();Ge.useState(null),N.useEffect(()=>{u(localStorage.getItem("user"))},[o]);const[l,c]=N.useState([]),p=async()=>{try{return _e.collection("admin").onSnapshot(R=>{const w=R.docs.map(S=>({id:S.id,...S.data()}));w.sort((S,P)=>{const F=parseInt(S.id.split("-")[0]),C=parseInt(P.id.split("-")[0]);return F-C}),c(w)})}catch{}};N.useEffect(()=>{p()},[]);const[m,g]=N.useState(!1);N.useEffect(()=>{const f=()=>{g(window.innerWidth<768)};return f(),window.addEventListener("resize",f),()=>{window.removeEventListener("resize",f)}},[]);const[b,y]=N.useState([]),d=b.filter(f=>f.request>="Awaiting Request");d.length>0&&d.length;const A=[{id:`/user/${t}`,title:t},{id:"/admindashboard",title:"Admin"},{id:"logout",title:"Logout"}];return $(Y,{children:[E(an,{setUserPermit:y}),E(Xe,{setUser:e,user:t,level:n,setLevel:s,setUuid:i,uuid:r}),r&&n>2&&E(Y,{children:E("div",{className:"flex font-mono items-center justify-center sm:w-[400px]  sm:items-center sm:m-auto sm:justify-around ",children:A.map((f,R)=>n<10&&f.id==="/admindashboard"?null:$("span",{className:" cursor-pointer mr-5 relative mt-2 mb-2 md:px-5 md:py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group",onClick:()=>{f.id==="logout"&&Ve.signOut().then(()=>{a("/"),localStorage.clear(),e(0),s(0),i(null)}),f.id==="/admindashboard"&&a("/admindashboard"),f.id===`/user/${t}`&&a(`/user/${t}`)},children:[E("span",{className:"absolute top-0 left-0 w-0 h-0 transition-all duration-200 border-t-2 border-yellow-600 group-hover:w-full ease"}),E("span",{className:"absolute bottom-0 right-0 w-0 h-0 transition-all duration-200 border-b-2 border-yellow-600 group-hover:w-full ease"}),E("span",{className:"absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"}),E("span",{className:"absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"}),E("span",{className:"absolute inset-0 w-full h-full duration-300 delay-300 bg-sky-900 opacity-0 group-hover:opacity-100"}),E("span",{className:"relative transition-colors duration-300 delay-200 group-hover:text-white ease",children:E("button",{className:"text-center text-sm cursor-pointer w-[70px] ",children:f.title})})]},R))})}),!r&&E(Y,{children:E("div",{className:"flex font-mono items-center justify-center sm:w-[300px]  sm:items-center sm:m-auto sm:justify-around ",children:$("button",{type:"button",className:"w-[80px] text-white bg-gradient-to-r mt-2 from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2",children:[" ",$(We,{to:"/login",className:"mr-10 mt-4",children:[" ","Login"," "]})]})})})]})}export{an as A,fn as N,cn as a,dn as g,hn as r,ln as u};
