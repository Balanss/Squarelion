 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $r=new Map,tl=new Map;function Bc(t,e){try{t.container.addComponent(e)}catch(n){Ui.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function BE(t,e){t.container.addOrOverwriteComponent(e)}function en(t){const e=t.name;if(tl.has(e))return Ui.debug(`There were multiple attempts to register component ${e}.`),!1;tl.set(e,t);for(const n of $r.values())Bc(n,t);return!0}function is(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function bP(t,e,n=Mr){is(t,e).clearInstance(n)}function OP(){tl.clear()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jr=xP;function Lg(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Mr,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw qn.create("bad-app-name",{appName:String(i)});if(n||(n=OE()),!n)throw qn.create("no-options");const s=$r.get(i);if(s){if(Vc(n,s.options)&&Vc(r,s.config))return s;throw qn.create("duplicate-app",{appName:i})}const o=new zx(i);for(const l of tl.values())o.addComponent(l);const a=new MP(n,r,o);return $r.set(i,a),a}function Mg(t=Mr){const e=$r.get(t);if(!e&&t===Mr&&OE())return Lg();if(!e)throw qn.create("no-app",{appName:t});return e}function $P(){return Array.from($r.values())}async function zE(t){const e=t.name;$r.has(e)&&($r.delete(e),await Promise.all(t.container.getProviders().map(n=>n.delete())),t.isDeleted=!0)}function vt(t,e,n){var r;let i=(r=PP[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ui.warn(a.join(" "));return}en(new bt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}function jE(t,e){if(t!==null&&typeof t!="function")throw qn.create("invalid-log-argument");Kx(t,e)}function qE(t){Gx(t)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FP="firebase-heartbeat-database",UP=1,nl="firebase-heartbeat-store";let cf=null;function WE(){return cf||(cf=nP(FP,UP,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(nl)}}}).catch(t=>{throw qn.create("idb-open",{originalErrorMessage:t.message})})),cf}async function VP(t){try{return await(await WE()).transaction(nl).objectStore(nl).get(GE(t))}catch(e){if(e instanceof et)Ui.warn(e.message);else{const n=qn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ui.warn(n.message)}}}async function s0(t,e){try{const r=(await WE()).transaction(nl,"readwrite");await r.objectStore(nl).put(e,GE(t)),await r.done}catch(n){if(n instanceof et)Ui.warn(n.message);else{const r=qn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ui.warn(r.message)}}}function GE(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oS=new Map;function aS(t,e){const n=Oh(t);lS(n,e),Ib(n,e)}function lS(t,e){const n=oS.get(t);if(n)for(const r of n)r(e)}function Ib(t,e){const n=_b();n&&n.postMessage({key:t,fid:e}),Eb()}let _i=null;function _b(){return!_i&&"BroadcastChannel"in self&&(_i=new BroadcastChannel("[Firebase] FID Change"),_i.onmessage=t=>{lS(t.data.key,t.data.fid)}),_i}function Eb(){oS.size===0&&_i&&(_i.close(),_i=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sb="firebase-installations-database",Tb=1,Bi="firebase-installations-store";let pf=null;function Ug(){return pf||(pf=ib(Sb,Tb,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Bi)}}})),pf}async function zc(t,e){const n=Oh(t),i=(await Ug()).transaction(Bi,"readwrite"),s=i.objectStore(Bi),o=await s.get(n);return await s.put(e,n),await i.done,(!o||o.fid!==e.fid)&&aS(t,e.fid),e}async function uS(t){const e=Oh(t),r=(await Ug()).transaction(Bi,"readwrite");await r.objectStore(Bi).delete(e),await r.done}async function Lh(t,e){const n=Oh(t),i=(await Ug()).transaction(Bi,"readwrite"),s=i.objectStore(Bi),o=await s.get(n),a=e(o);return a===void 0?await s.delete(n):await s.put(a,n),await i.done,a&&(!o||o.fid!==a.fid)&&aS(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AO={"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance."},w0=new er("app-compat","Firebase",AO);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yS(){const t=NO(CO);t.INTERNAL=Object.assign(Object.assign({},t.INTERNAL),{createFirebaseNamespace:yS,extendNamespace:e,createSubscribe:$E,ErrorFactory:er,deepExtend:Uc});function e(n){Uc(t,n)}return t}const RO=yS();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qc=new Ml("@firebase/auth");function FO(t,...e){qc.logLevel<=Y.WARN&&qc.warn(`Auth (${Jr}): ${t}`,...e)}function ec(t,...e){qc.logLevel<=Y.ERROR&&qc.error(`Auth (${Jr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PS(t,e=[]){let n;switch(t){case"Browser":n=S0(we());break;case"Worker":n=`${S0(we())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Jr}/${r}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vf(t,e){return tr(t,"POST","/v1/accounts:signInWithPassword",Oe(t,e))}async function $h(t,e){return Fe(t,"POST","/v1/accounts:sendOobCode",Oe(t,e))}async function yL(t,e){return $h(t,e)}async function wf(t,e){return $h(t,e)}async function If(t,e){return $h(t,e)}async function vL(t,e){return $h(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tc(t,e){return tr(t,"POST","/v1/accounts:signUp",Oe(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zS(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await Yn(t,VS(r,i,e,t),n);A(s.idToken,r,"internal-error");const o=Mh(s.idToken);A(o,r,"internal-error");const{sub:a}=o;return A(t.uid===a,r,"user-mismatch"),tn._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&it(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XS extends QS{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}XS.type="SESSION";const zi=XS;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n$=500;class r${constructor(){this._redirectPersistence=zi,this._shouldInitProactively=!0,this.eventManagers=new Map,this.originValidationPromises={},this._completeRedirectFn=qh,this._overrideRedirectResult=sy}async _initialize(e){const n=e._key();let r=this.eventManagers.get(n);return r||(r=new QM(e),this.eventManagers.set(n,r),this.attachCallbackListeners(e,r)),r}_openPopup(e){it(e,"operation-not-supported-in-this-environment")}async _openRedirect(e,n,r,i){WM(e);const s=await this._initialize(e);await s.initialized(),s.resetRedirect(),J2(),await this._originValidation(e);const o=YM(e,r,i);await XM(e,o);const a=await BM(e,o,n),l=await jM(a);return qM(e,s,l)}_isIframeWebStorageSupported(e,n){throw new Error("Method not implemented.")}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=zM(e)),this.originValidationPromises[n]}attachCallbackListeners(e,n){const{universalLinks:r,handleOpenURL:i,BuildInfo:s}=qi(),o=setTimeout(async()=>{await M0(e),n.onEvent($0())},n$),a=async c=>{clearTimeout(o);const h=await M0(e);let d=null;h&&(c!=null&&c.url)&&(d=JM(h,c.url)),n.onEvent(d||$0())};typeof r<"u"&&typeof r.subscribe=="function"&&r.subscribe(null,a);const l=i,u=`${s.packageName.toLowerCase()}://`;qi().handleOpenURL=async c=>{if(c.toLowerCase().startsWith(u)&&a({url:c}),typeof l=="function")try{l(c)}catch(h){console.error(h)}}}}const i$=r$;function $0(){return{type:"unknown",eventId:null,sessionId:null,urlResponse:null,postBody:null,tenantId:null,error:tt("no-auth-event")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt={LOCAL:"local",NONE:"none",SESSION:"session"},Ho=A,fT="persistence";function g$(t,e){if(Ho(Object.values(Mt).includes(e),t,"invalid-persistence-type"),Pg()){Ho(e!==Mt.SESSION,t,"unsupported-persistence-type");return}if(Dg()){Ho(e===Mt.NONE,t,"unsupported-persistence-type");return}if(ay()){Ho(e===Mt.NONE||e===Mt.LOCAL&&to(),t,"unsupported-persistence-type");return}Ho(e===Mt.NONE||hT(),t,"unsupported-persistence-type")}async function Gp(t){await t._initializationPromise;const e=pT(),n=Di(fT,t.config.apiKey,t.name);e&&e.setItem(n,t._getPersistence())}function y$(t,e){const n=pT();if(!n)return[];const r=Di(fT,t,e);switch(n.getItem(r)){case Mt.NONE:return[no];case Mt.LOCAL:return[al,zi];case Mt.SESSION:return[zi];default:return[]}}function pT(){var t;try{return((t=m$())===null||t===void 0?void 0:t.sessionStorage)||null}catch{return null}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ly{constructor(){this.providerId="phone",this._delegate=new ji(mT(Ln.auth()))}static credential(e,n){return ji.credential(e,n)}verifyPhoneNumber(e,n){return this._delegate.verifyPhoneNumber(e,n)}unwrap(){return this._delegate}}ly.PHONE_SIGN_IN_METHOD=ji.PHONE_SIGN_IN_METHOD;ly.PROVIDER_ID=ji.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ni(t){if(t.code!==I.FAILED_PRECONDITION||t.message!==kk)throw t;T("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rr{constructor(e,n=null,r=[],i=[],s=null,o="F",a=null,l=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=i,this.limit=s,this.limitType=o,this.startAt=a,this.endAt=l,this.wt=null,this._t=null,this.startAt,this.endAt}}function jk(t,e,n,r,i,s,o,a){return new rr(t,e,n,r,i,s,o,a)}function Do(t){return new rr(t)}function pI(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function My(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function ud(t){for(const e of t.filters){const n=e.getFirstInequalityField();if(n!==null)return n}return null}function $y(t){return t.collectionGroup!==null}function bi(t){const e=P(t);if(e.wt===null){e.wt=[];const n=ud(e),r=My(e);if(n!==null&&r===null)n.isKeyField()||e.wt.push(new Gs(n)),e.wt.push(new Gs(Ae.keyField(),"asc"));else{let i=!1;for(const s of e.explicitOrderBy)e.wt.push(s),s.field.isKeyField()&&(i=!0);if(!i){const s=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.wt.push(new Gs(Ae.keyField(),s))}}}return e.wt}function Ot(t){const e=P(t);if(!e._t)if(e.limitType==="F")e._t=pm(e.path,e.collectionGroup,bi(e),e.filters,e.limit,e.startAt,e.endAt);else{const n=[];for(const s of bi(e)){const o=s.dir==="desc"?"asc":"desc";n.push(new Gs(s.field,o))}const r=e.endAt?new qr(e.endAt.position,e.endAt.inclusive):null,i=e.startAt?new qr(e.startAt.position,e.startAt.inclusive):null;e._t=pm(e.path,e.collectionGroup,n,e.filters,e.limit,r,i)}return e._t}function mm(t,e){e.getFirstInequalityField(),ud(t);const n=t.filters.concat([e]);return new rr(t.path,t.collectionGroup,t.explicitOrderBy.slice(),n,t.limit,t.limitType,t.startAt,t.endAt)}function sh(t,e,n){return new rr(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Zl(t,e){return Jl(Ot(t),Ot(e))&&t.limitType===e.limitType}function qk(t){return`${Ki(Ot(t))}|lt:${t.limitType}`}function gm(t){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(r=>Vk(r)).join(", ")}]`),Xl(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(r=>function(i){return`${i.field.canonicalString()} (${i.dir})`}(r)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(r=>oo(r)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(r=>oo(r)).join(",")),`Target(${n})`}(Ot(t))}; limitType=${t.limitType})`}function eu(t,e){return e.isFoundDocument()&&function(n,r){const i=r.key.path;return n.collectionGroup!==null?r.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(i):R.isDocumentKey(n.path)?n.path.isEqual(i):n.path.isImmediateParentOf(i)}(t,e)&&function(n,r){for(const i of bi(n))if(!i.field.isKeyField()&&r.data.field(i.field)===null)return!1;return!0}(t,e)&&function(n,r){for(const i of n.filters)if(!i.matches(r))return!1;return!0}(t,e)&&function(n,r){return!(n.startAt&&!function(i,s,o){const a=cI(i,s,o);return i.inclusive?a<=0:a<0}(n.startAt,bi(n),r)||n.endAt&&!function(i,s,o){const a=cI(i,s,o);return i.inclusive?a>=0:a>0}(n.endAt,bi(n),r))}(t,e)}function Wk(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function Gk(t){return(e,n)=>{let r=!1;for(const i of bi(t)){const s=NU(i,e,n);if(s!==0)return s;r=r||i.field.isKeyField()}return 0}}function NU(t,e,n){const r=t.field.isKeyField()?R.comparator(e.key,n.key):function(i,s,o){const a=s.data.field(i),l=o.data.field(i);return a!==null&&l!==null?jr(a,l):O()}(t.field,e,n);switch(t.dir){case"asc":return r;case"desc":return-1*r;default:return O()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RU=new se(R.comparator);function Nt(){return RU}const Kk=new se(R.comparator);function fa(...t){let e=Kk;for(const n of t)e=e.insert(n.key,n);return e}function Hk(t){let e=Kk;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function An(){return Pa()}function Qk(){return Pa()}function Pa(){return new ii(t=>t.toString(),(t,e)=>t.isEqual(e))}const DU=new se(R.comparator),xU=new he(R.comparator);function j(...t){let e=xU;for(const n of t)e=e.add(n);return e}const PU=new he(z);function Fy(){return PU}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cd{constructor(){this._=void 0}}function bU(t,e,n){return t instanceof lo?function(r,i){const s={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return i&&ld(i)&&(i=Oy(i)),i&&(s.fields.__previous_value__=i),{mapValue:s}}(n,e):t instanceof Hi?eC(t,e):t instanceof Qi?tC(t,e):function(r,i){const s=Zk(r,i),o=mI(s)+mI(r.gt);return hm(s)&&hm(r.gt)?Xk(o):Yk(r.serializer,o)}(t,e)}function OU(t,e,n){return t instanceof Hi?eC(t,e):t instanceof Qi?tC(t,e):n}function Zk(t,e){return t instanceof uo?hm(n=e)||function(r){return!!r&&"doubleValue"in r}(n)?e:{integerValue:0}:null;var n}class lo extends cd{}class Hi extends cd{constructor(e){super(),this.elements=e}}function eC(t,e){const n=nC(e);for(const r of t.elements)n.some(i=>bn(i,r))||n.push(r);return{arrayValue:{values:n}}}class Qi extends cd{constructor(e){super(),this.elements=e}}function tC(t,e){let n=nC(e);for(const r of t.elements)n=n.filter(i=>!bn(i,r));return{arrayValue:{values:n}}}class uo extends cd{constructor(e,n){super(),this.serializer=e,this.gt=n}}function mI(t){return _e(t.integerValue||t.doubleValue)}function nC(t){return Il(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nu{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,ru.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new nu(F.min(),i,new se(z),Nt(),j())}}class ru{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new ru(r,n,j(),j(),j())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _C{constructor(e){this.fe=e}}function tV(t,e){let n;if(e.document)n=pC(t.fe,e.document,!!e.hasCommittedMutations);else if(e.noDocument){const r=R.fromSegments(e.noDocument.path),i=Xi(e.noDocument.readTime);n=ue.newNoDocument(r,i),e.hasCommittedMutations&&n.setHasCommittedMutations()}else{if(!e.unknownDocument)return O();{const r=R.fromSegments(e.unknownDocument.path),i=Xi(e.unknownDocument.version);n=ue.newUnknownDocument(r,i)}}return e.readTime&&n.setReadTime(function(r){const i=new me(r[0],r[1]);return F.fromTimestamp(i)}(e.readTime)),n}function kI(t,e){const n=e.key,r={prefixPath:n.getCollectionPath().popLast().toArray(),collectionGroup:n.collectionGroup,documentId:n.path.lastSegment(),readTime:oh(e.readTime),hasCommittedMutations:e.hasCommittedMutations};if(e.isFoundDocument())r.document=function(i,s){return{name:_l(i,s.key),fields:s.data.value.mapValue.fields,updateTime:co(i,s.version.toTimestamp()),createTime:co(i,s.createTime.toTimestamp())}}(t.fe,e);else if(e.isNoDocument())r.noDocument={path:n.path.toArray(),readTime:Yi(e.version)};else{if(!e.isUnknownDocument())return O();r.unknownDocument={path:n.path.toArray(),version:Yi(e.version)}}return r}function oh(t){const e=t.toTimestamp();return[e.seconds,e.nanoseconds]}function Yi(t){const e=t.toTimestamp();return{seconds:e.seconds,nanoseconds:e.nanoseconds}}function Xi(t){const e=new me(t.seconds,t.nanoseconds);return F.fromTimestamp(e)}function pi(t,e){const n=(e.baseMutations||[]).map(s=>wm(t.fe,s));for(let s=0;s<e.mutations.length-1;++s){const o=e.mutations[s];if(s+1<e.mutations.length&&e.mutations[s+1].transform!==void 0){const a=e.mutations[s+1];o.updateTransforms=a.transform.fieldTransforms,e.mutations.splice(s+1,1),++s}}const r=e.mutations.map(s=>wm(t.fe,s)),i=me.fromMillis(e.localWriteTimeMs);return new Vy(e.batchId,i,n,r)}function ma(t){const e=Xi(t.readTime),n=t.lastLimboFreeSnapshotVersion!==void 0?Xi(t.lastLimboFreeSnapshotVersion):F.min();let r;var i;return t.query.documents!==void 0?(U((i=t.query).documents.length===1),r=Ot(Do(dC(i.documents[0])))):r=function(s){return Ot(yC(s))}(t.query),new zn(r,t.targetId,"TargetPurposeListen",t.lastListenSequenceNumber,e,n,$e.fromBase64String(t.resumeToken))}function EC(t,e){const n=Yi(e.snapshotVersion),r=Yi(e.lastLimboFreeSnapshotVersion);let i;i=rh(e.target)?mC(t.fe,e.target):gC(t.fe,e.target);const s=e.resumeToken.toBase64();return{targetId:e.targetId,canonicalId:Ki(e.target),readTime:n,resumeToken:s,lastListenSequenceNumber:e.sequenceNumber,lastLimboFreeSnapshotVersion:r,query:i}}function Gy(t){const e=yC({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?sh(e,e.limit,"L"):e}function bf(t,e){return new zy(e.largestBatchId,wm(t.fe,e.overlayMutation))}function CI(t,e){const n=e.path.lastSegment();return[t,wt(e.path.popLast()),n]}function AI(t,e,n,r){return{indexId:t,uid:e.uid||"",sequenceNumber:n,readTime:Yi(r.readTime),documentKey:wt(r.documentKey.path),largestBatchId:r.largestBatchId}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class NC{constructor(){this.changes=new ii(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,ue.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?w.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(e){this._delegate=e}static serverTimestamp(){const e=RB();return e._methodName="FieldValue.serverTimestamp",new yi(e)}static delete(){const e=NB();return e._methodName="FieldValue.delete",new yi(e)}static arrayUnion(...e){const n=RA(...e);return n._methodName="FieldValue.arrayUnion",new yi(n)}static arrayRemove(...e){const n=DB(...e);return n._methodName="FieldValue.arrayRemove",new yi(n)}static increment(e){const n=xB(e);return n._methodName="FieldValue.increment",new yi(n)}isEqual(e){return this._delegate.isEqual(e._delegate)}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VB(t){UB(t,(e,n)=>new DA(e,n,new LB)),t.registerVersion(PB,bB)}VB(Ln);const BB={apiKey:"AIzaSyDmeCKj1u6joV57Opj22FUUvQCbgaW7qtI",authDomain:"squarelion-43d29.firebaseapp.com",projectId:"squarelion-43d29",storageBucket:"squarelion-43d29.appspot.com",messagingSenderId:"171439211836",appId:"1:171439211836:web:5aba3918d87876d0d84a39",measurementId:"G-9S8TZFG63M"},LA=Ln.initializeApp(BB);EO(LA);const zB=Ln.auth(),jB=Ln.firestore(),qB=z4(LA);Ln.firestore();new ln;const lz=new Ln.auth.GoogleAuthProvider;function WB({user:t,setUser:e,setUuid:n,setLevel:r,level:i}){D.useEffect(()=>zB.onAuthStateChanged(o=>{o?(n(o.uid),localStorage.getItem("user"),jB.collection("admin").doc(o.uid).get().then(a=>{const l=a.data();e(l.Name),r(l.level),localStorage.setItem("user",l.Name)})):(e(null),r(null))}),[])}const GB="https://Balanss.github.io/Squarelion/assets/404-6a88564e.jpg";class KB extends g_.Component{constructor(e){super(e),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0}}componentDidCatch(e,n){console.log(e,n)}render(){return this.state.hasError?ae("div",{className:"absolute z-50  inset-0 opacity-100",children:ae("img",{className:` w-full h-full transition-opacity duration-1000 opacity-75
          }`,src:GB,alt:"Header Background"})}):this.props.children}}const HB=D.lazy(()=>ns(()=>import("./Admin-98cebaa8.js"),["assets/Admin-98cebaa8.js","assets/Nav-9e453dca.js","assets/PartnerLogic-c01f4ea2.js","assets/user-136f2847.js","assets/Version-d6acd514.js"])),QB=D.lazy(()=>ns(()=>import("./Login-61c453de.js"),["assets/Login-61c453de.js","assets/Nav-9e453dca.js","assets/Logo-4b9c1084.js"])),YB=D.lazy(()=>ns(()=>import("./Home-aeff2153.js"),["assets/Home-aeff2153.js","assets/Nav-9e453dca.js","assets/useLogo-28cee2dd.js"])),XB=D.lazy(()=>ns(()=>import("./Profile-5f96052e.js"),["assets/Profile-5f96052e.js","assets/Nav-9e453dca.js","assets/useLogo-28cee2dd.js","assets/DesignerFunctions-f183d767.js","assets/Links-ac18b1b5.js","assets/Logo-4b9c1084.js","assets/PartnerLogic-c01f4ea2.js","assets/user-136f2847.js","assets/Version-d6acd514.js","assets/Profile-850b1b4b.css"])),JB=D.lazy(()=>ns(()=>import("./SwitchingFromLegacyToNew-689a2dad.js").then(t=>t.S),["assets/SwitchingFromLegacyToNew-689a2dad.js","assets/Nav-9e453dca.js","assets/Links-ac18b1b5.js","assets/Logo-4b9c1084.js","assets/PartnerLogic-c01f4ea2.js","assets/DesignerFunctions-f183d767.js","assets/Version-d6acd514.js","assets/Typography-0daea7bd.js","assets/SwitchingFromLegacyToNew-8e59e50e.css"])),ZB=D.lazy(()=>ns(()=>import("./Designer-eeb29f58.js"),["assets/Designer-eeb29f58.js","assets/Nav-9e453dca.js","assets/DesignerFunctions-f183d767.js","assets/Typography-0daea7bd.js"])),ez=D.lazy(()=>ns(()=>import("./SqlProperties-0b826ab4.js"),["assets/SqlProperties-0b826ab4.js","assets/Nav-9e453dca.js","assets/Version-d6acd514.js"]));function tz(){const[t,e]=D.useState(0),[n,r]=D.useState(""),[i,s]=D.useState(""),[o,a]=D.useState(null);return D.useEffect(()=>{if(navigator.geolocation.getCurrentPosition(l=>{a(l.coords.latitude.toString())}),i){const l=localStorage.getItem("entryDate"),u=new Date().toLocaleDateString();if(l===u&&o==="5.8251")console.log("Already visited today in office");else if(o==="5.8251"||o==="5.8507"||o==="5.8295"||o==="5.804"){console.log("at the office login");const c=new Date().toLocaleString();localStorage.setItem("entryDate",u),localStorage.setItem("entryTime",c);const h=Iv(qB,"admin"),d=kl(h,i);Dm(d,{LoggedIn:new Date().toLocaleString(),logs:RA(new Date().toLocaleString())},{merge:!0})}else console.log("Not in office"),console.log(o)}},[i,t,o]),ae(oN,{children:ae(ox,{children:ae(KB,{children:ae(D.Suspense,{fallback:Ff("div",{children:[" ",ae(hx,{}),ae(WB,{setUser:e,user:t,level:n,setLevel:r,setUuid:s,uuid:i})]}),children:Ff(ex,{children:[ae(hr,{path:"/admindashboard",element:ae(HB,{})}),ae(hr,{path:"/login",element:ae(QB,{})}),ae(hr,{path:"/",element:ae(YB,{})}),ae(hr,{path:"/profile/:id",element:ae(JB,{})}),ae(hr,{path:"/user/:id",element:ae(XB,{})}),ae(hr,{path:"/designer",element:ae(ZB,{})}),ae(hr,{path:"/sqlProp",element:ae(ez,{})})]})})})})})}Uf.createRoot(document.getElementById("root")).render(ae(tz,{}));export{Tx as A,et as B,bt as C,Dg as D,oN as F,NA as I,NB as K,sz as L,RA as Q,g_ as R,Jr as S,WB as U,Iv as _,Ff as a,zB as b,Dm as c,qB as d,hx as e,lz as f,kl as g,jB as h,o_ as i,ae as j,_E as k,rz as l,r_ as m,iz as n,ns as o,nz as p,ZA as q,D as r,V as s,is as t,UD as u,_x as v,Mg as w,en as x,_B as y,vt as z};
