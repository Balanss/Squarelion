import{r as Ka}from"./index-5a27fc07.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p_{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(m_(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function m_(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Nc="@firebase/app",Fh="0.9.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tI(n){Je(new Ve("platform-logger",e=>new p_(e),"PRIVATE")),Je(new Ve("heartbeat",e=>new J_(e),"PRIVATE")),Se(Nc,Fh,n),Se(Nc,Fh,"esm2017"),Se("fire-js","")}tI("");const nI=Object.freeze(Object.defineProperty({__proto__:null,FirebaseError:ge,SDK_VERSION:Mt,_DEFAULT_ENTRY_NAME:Zt,_addComponent:vo,_addOrOverwriteComponent:op,_apps:en,_clearComponents:j_,_components:Ui,_getProvider:dn,_registerComponent:Je,_removeServiceInstance:q_,deleteApp:ap,getApp:Qo,getApps:K_,initializeApp:Nu,onLog:cp,registerVersion:Se,setLogLevel:up},Symbol.toStringTag,{value:"Module"}));var rI="firebase",iI="9.22.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zh=new hs("@firebase/app-compat"),VT="@firebase/app-compat",BT="0.2.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */if(Lw()&&self.firebase!==void 0){Zh.warn(`
  ...
  `);const n=self.firebase.SDK_VERSION;n&&n.indexOf("LITE")>=0&&Zh.warn(`
    ...
    `)}const St=UT;$T();var qT="firebase",jT="9.22.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gC{constructor(e){this.collectionId=e.collectionGroup!=null?e.collectionGroup:e.path.lastSegment(),this.Ye=e.orderBy,this.Xe=[];for(const t of e.filters){const r=t;r.isInequality()?this.Ze=r:this.Xe.push(r)}}tn(e){k(e.collectionGroup===this.collectionId);const t=eu(e);if(t!==void 0&&!this.en(t))return!1;const r=Tn(e);let i=0,s=0;for(;i<r.length&&this.en(r[i]);++i);if(i===r.length)return!0;if(this.Ze!==void 0){const o=r[i];if(!this.nn(this.Ze,o)||!this.sn(this.Ye[s++],o))return!1;++i}for(;i<r.length;++i){const o=r[i];if(s>=this.Ye.length||!this.sn(this.Ye[s++],o))return!1}return!0}en(e){for(const t of this.Xe)if(this.nn(t,e))return!0;return!1}nn(e,t){if(e===void 0||!e.field.isEqual(t.fieldPath))return!1;const r=e.op==="array-contains"||e.op==="array-contains-any";return t.kind===2===r}sn(e,t){return!!e.field.isEqual(t.fieldPath)&&(t.kind===0&&e.dir==="asc"||t.kind===1&&e.dir==="desc")}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
