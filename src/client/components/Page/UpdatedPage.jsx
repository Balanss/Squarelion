                   ...
                   { item.month === month && (
                    <Draggable key={index} index={index} draggableId={`${item.order}`}>
                      {(provided) => (
                         ...
                         <motion.div variants={container} className="border-[1px] border-y-[#2c1f42] bg-secondary  grid grid-cols-6 phones:gap-y-10 laptop:grid-cols-8 gap-y-5 items-center text-left py-1 rounded laptop:w-[80vw] m-auto">
