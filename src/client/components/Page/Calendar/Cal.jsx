...
<form onSubmit={handleSubmit} className=' mr-2 gap-5 flex flex-col items-center  bg-slate-800 p-5 xl:px-[70px] xl:py-[50px] border-2 border-slate-700 rounded-md '>
...
<div className={`${calLoading === false? 'block':'hidden'} bg-slate-700 rounded-md`}>
  <GoogleCalendar/>
</div>
</section>
        </div>
